  ...
  return {
    ...
    initialize: function () {
      ...
      this.button_url = $('<a href="javascript:;" class="btn btn-default">' +
                          ...
                          this._('Link') + '</a>')
        .prop('title', this._('Bir bağlantı linki giriniz (API bağlantısı da kurabilirsiniz)'))
      ...
      $('label[for="field-image-upload"]').text(options.upload_label || this._('Resim'));
      ...
      this.input
        ...
        .prop('title', this._('Bilgisayarınızdan bir dosya yükleyin'))
