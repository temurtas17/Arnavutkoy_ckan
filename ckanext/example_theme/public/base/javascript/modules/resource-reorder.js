...
this.ckan.module('resource-reorder', function($) {
    return {
      ...
      initialize: function() {
        ...
        var labelText = this._('Kaynakları yeniden sıralayın');
        var helpText = this._('Ok simgesini kullanarak, kaynakları sürükleyip yeniden düzenleyebilirsiniz. ' +
          'Kaynağı sağa sürükleyin ve listede istediğiniz konuma yerleştirin. İşiniz bittiğinde, "Sırayı kaydet" düğmesine tıklayın.');
